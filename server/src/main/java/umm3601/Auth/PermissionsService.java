...
public class PermissionsService {
  ...
  // Add app-specific @RequirePermission values here as new project features are built.
  ...
  public List<String> getAvailablePermissions() {
    return new ArrayList<>(new TreeSet<>(ROUTE_PERMISSIONS));
  }
   ...
   * role that has no project-specific permissions and no inherited roles. This
   ...
   * The "volunteer_base" role serves as a foundational role that can be inherited
   * by other custom job roles as new project permissions are added.
   *
